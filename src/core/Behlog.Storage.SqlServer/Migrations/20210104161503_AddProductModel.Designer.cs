...
namespace Behlog.Storage.SqlServer.Migrations
{
    ...
    [Migration("20210104161503_AddProductModel")]
            ...
            modelBuilder.Entity("Behlog.Core.Models.Shop.Shipping", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2021, 1, 4, 16, 15, 1, 225, DateTimeKind.Utc).AddTicks(1467),
                            IsFree = true,
                            MaxDeliveryDays = 0,
                            MinDeliveryDays = 0,
                            ModifyDate = new DateTime(2021, 1, 4, 16, 15, 1, 225, DateTimeKind.Utc).AddTicks(2640),
                            Price = 0m,
                            Status = 1,
                            Title = "پست"
                        });
