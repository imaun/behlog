...
namespace Behlog.Storage.SqlServer.Migrations
{
    ...
    [Migration("20201123163954_BlockDesigns")]
    partial class BlockDesigns
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Behlog.Core.Models.Content.Block", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Behlog.Core.Models.Content.BlockSample", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Behlog.Core.Models.Content.PostBlock", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Behlog.Core.Models.Content.Block", b =>
                {
                    b.HasOne("Behlog.Core.Models.Security.User", "AddedByUser")
                        .WithMany("AddedBlocks")
                        .HasForeignKey("AddedByUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Behlog.Core.Models.Content.Block", "Parent")
            ...
            modelBuilder.Entity("Behlog.Core.Models.Content.BlockSample", b =>
                {
                    b.HasOne("Behlog.Core.Models.Content.Block", "Block")
                        .WithMany("Samples")
