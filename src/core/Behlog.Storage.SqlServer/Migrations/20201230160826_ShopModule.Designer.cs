...
namespace Behlog.Storage.SqlServer.Migrations
{
    ...
    [Migration("20201230160826_ShopModule")]
            ...
            modelBuilder.Entity("Behlog.Core.Models.Shop.Shipping", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2020, 12, 30, 16, 8, 24, 503, DateTimeKind.Utc).AddTicks(5407),
                            IsFree = true,
                            MaxDeliveryDays = 0,
                            MinDeliveryDays = 0,
                            ModifyDate = new DateTime(2020, 12, 30, 16, 8, 24, 503, DateTimeKind.Utc).AddTicks(6703),
                            Price = 0m,
                            Status = 1,
                            Title = "پست"
                        });
