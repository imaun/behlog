...
namespace Behlog.Storage.SqlServer.Migrations
{
    ...
    [Migration("20210106123533_BasketMap")]
    partial class BasketMap
    {
            ...
            modelBuilder.Entity("Behlog.Core.Models.Shop.Shipping", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2021, 1, 6, 12, 35, 30, 205, DateTimeKind.Utc).AddTicks(1977),
                            IsFree = true,
                            MaxDeliveryDays = 0,
                            MinDeliveryDays = 0,
                            ModifyDate = new DateTime(2021, 1, 6, 12, 35, 30, 205, DateTimeKind.Utc).AddTicks(3133),
                            Price = 0m,
                            Status = 1,
                            Title = "پست"
                        });
