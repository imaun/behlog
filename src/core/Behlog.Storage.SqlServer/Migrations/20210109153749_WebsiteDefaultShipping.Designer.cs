...
namespace Behlog.Storage.SqlServer.Migrations
{
    ...
    [Migration("20210109153749_WebsiteDefaultShipping")]
    partial class WebsiteDefaultShipping
    {
            ...
            modelBuilder.Entity("Behlog.Core.Models.Shop.Shipping", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2021, 1, 9, 15, 37, 44, 847, DateTimeKind.Utc).AddTicks(7422),
                            IsFree = true,
                            MaxDeliveryDays = 0,
                            MinDeliveryDays = 0,
                            ModifyDate = new DateTime(2021, 1, 9, 15, 37, 44, 847, DateTimeKind.Utc).AddTicks(8864),
                            Price = 0m,
                            Status = 1,
                            Title = "پست"
                        });
