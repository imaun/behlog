...
namespace Behlog.Storage.SqlServer.Migrations
{
    ...
    [Migration("20210106080957_ProductModelMap")]
    partial class ProductModelMap
    {
            ...
            modelBuilder.Entity("Behlog.Core.Models.Shop.Shipping", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2021, 1, 6, 8, 9, 54, 651, DateTimeKind.Utc).AddTicks(5480),
                            IsFree = true,
                            MaxDeliveryDays = 0,
                            MinDeliveryDays = 0,
                            ModifyDate = new DateTime(2021, 1, 6, 8, 9, 54, 651, DateTimeKind.Utc).AddTicks(7407),
                            Price = 0m,
                            Status = 1,
                            Title = "پست"
                        });
