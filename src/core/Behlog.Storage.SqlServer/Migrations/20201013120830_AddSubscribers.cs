    ...
    public partial class AddSubscribers : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Feature.Subscriptions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Feature.Subscriptions_System.Websites_WebsiteId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Feature.Subscriptions_WebsiteId",
                table: "Feature.Subscriptions",
                column: "WebsiteId");
        }
