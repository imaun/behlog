...
namespace Behlog.Storage.SqlServer.Migrations
{
    ...
    [Migration("20210113121412_PaymentNullablePayDate")]
    partial class PaymentNullablePayDate
    {
            ...
            modelBuilder.Entity("Behlog.Core.Models.Shop.Shipping", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2021, 1, 13, 12, 14, 8, 257, DateTimeKind.Utc).AddTicks(1822),
                            IsFree = true,
                            MaxDeliveryDays = 0,
                            MinDeliveryDays = 0,
                            ModifyDate = new DateTime(2021, 1, 13, 12, 14, 8, 257, DateTimeKind.Utc).AddTicks(4119),
                            Price = 0m,
                            Status = 1,
                            Title = "پست"
                        });
