...
namespace Behlog.Storage.SqlServer.Migrations
{
    ...
    [Migration("20210106122851_Basket")]
            ...
            modelBuilder.Entity("Behlog.Core.Models.Shop.Shipping", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2021, 1, 6, 12, 28, 48, 80, DateTimeKind.Utc).AddTicks(478),
                            IsFree = true,
                            MaxDeliveryDays = 0,
                            MinDeliveryDays = 0,
                            ModifyDate = new DateTime(2021, 1, 6, 12, 28, 48, 80, DateTimeKind.Utc).AddTicks(2508),
                            Price = 0m,
                            Status = 1,
                            Title = "پست"
                        });
