...
namespace Behlog.Storage.SqlServer.Migrations
{
    ...
    [Migration("20210103151656_PaymentStatus")]
            ...
            modelBuilder.Entity("Behlog.Core.Models.Shop.Shipping", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2021, 1, 3, 15, 16, 54, 413, DateTimeKind.Utc).AddTicks(2331),
                            IsFree = true,
                            MaxDeliveryDays = 0,
                            MinDeliveryDays = 0,
                            ModifyDate = new DateTime(2021, 1, 3, 15, 16, 54, 413, DateTimeKind.Utc).AddTicks(3475),
                            Price = 0m,
                            Status = 1,
                            Title = "پست"
                        });
