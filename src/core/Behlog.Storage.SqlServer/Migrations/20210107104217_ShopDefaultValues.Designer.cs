...
namespace Behlog.Storage.SqlServer.Migrations
{
    ...
    [Migration("20210107104217_ShopDefaultValues")]
    partial class ShopDefaultValues
    {
            ...
            modelBuilder.Entity("Behlog.Core.Models.Shop.Shipping", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2021, 1, 7, 10, 42, 14, 274, DateTimeKind.Utc).AddTicks(2304),
                            IsFree = true,
                            MaxDeliveryDays = 0,
                            MinDeliveryDays = 0,
                            ModifyDate = new DateTime(2021, 1, 7, 10, 42, 14, 274, DateTimeKind.Utc).AddTicks(3677),
                            Price = 0m,
                            Status = 1,
                            Title = "پست"
                        });
