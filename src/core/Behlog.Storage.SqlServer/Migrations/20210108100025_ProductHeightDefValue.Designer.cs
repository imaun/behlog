...
namespace Behlog.Storage.SqlServer.Migrations
{
    ...
    [Migration("20210108100025_ProductHeightDefValue")]
    partial class ProductHeightDefValue
    {
            ...
            modelBuilder.Entity("Behlog.Core.Models.Shop.Shipping", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2021, 1, 8, 10, 0, 20, 10, DateTimeKind.Utc).AddTicks(217),
                            IsFree = true,
                            MaxDeliveryDays = 0,
                            MinDeliveryDays = 0,
                            ModifyDate = new DateTime(2021, 1, 8, 10, 0, 20, 10, DateTimeKind.Utc).AddTicks(2122),
                            Price = 0m,
                            Status = 1,
                            Title = "پست"
                        });
