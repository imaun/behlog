    ...
    public static partial class TableMapper {
        ...
        public static void AddBlockMapping(this ModelBuilder builder) {
            builder.Entity<Block>(map => {
                map.ToTable(DbConst.Block_Table_Name).HasKey(_=> _.Id);

                map.Property(_ => _.Attributes).HasColumnType("nTEXT");
                ...
                map.Property(_ => _.Src).HasColumnType("nTEXT").IsRequired();
        ...
        public static void AddPostBlockMapping(this ModelBuilder builder) {
            builder.Entity<PostBlock>(map => {
                map.ToTable(DbConst.PostBlock_Table_Name).HasKey(_ => _.Id);

                map.Property(_ => _.OutputSrc).HasColumnType("nTEXT");
        ...
        public static void AddBlockSampleMapping(this ModelBuilder builder) {
            builder.Entity<BlockSample>(map => {
                map.ToTable(DbConst.BlockSample_Table_Name).HasKey(_ => _.Id);

                map.Property(_ => _.Title).HasMaxLength(300).IsUnicode().IsRequired();
                map.Property(_ => _.Attributes).HasColumnType("nTEXT").IsRequired();
                map.Property(_ => _.OutputSrc).HasColumnType("nTEXT");
                map.Property(_ => _.Description).HasMaxLength(1000).IsUnicode();
